  ...
  return (
    <section className=" grid grid-cols-1 lg:grid-cols-12 mt-5 w-full p-4 sm:p-10 gap-5 ">
      <BlurFade className=" relative w-full lg:col-span-8">
        ...
        >
          <source src="/home/final.mp4" type="video/mp4" />
      ...
      <div className=" md:col-span-4 flex flex-col gap-5 group/cardthree">
        <BlurFade
          y={0}
          x={20}
          className="border shadow  border-black/10 bg-[#f0ecec] flex flex-col justify-between relative rounded-3xl gap-3 p-8"
        >
        ...
        <BlurFade y={0} x={20} className="">
          ...
          <div
            ...
            className=" absolute -top-1 -right-1 bg-[#FAF9F6]   rounded-full  p-3 transition-all duration-200 ease-in-out group-hover/cardthree:translate-x-2 group-hover/cardthree:-translate-y-2  z-10 size-16"
          >
            <MoveUpRight className=" group-hover/cardthree:rotate-180 shadow-lg bg-black p-2 transition-all duration-200 ease-in-out  text-white size-full rounded-full" />
          </div>
          <div className=" absolute left-0 bottom-0 p-5 rounded-b-3xl transition-all duration-200 ease-in-out  group-hover/cardthree:backdrop-blur-lg text-white text-lg backdrop-blur-sm ">
            <p className=" rounded-3xl ">
              Experience luxurious comfort and durability with our elegantly
              crafted outdoor sofa, designed to elevate your outdoor living
              space
            </p>
          </div>
        </BlurFade>
